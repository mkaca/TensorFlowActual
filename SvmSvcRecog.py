...
def load_letter(folder, min_num_images):
  ...
  for image in image_files:
    ...
    try:
      ...
      image_data = np.reshape(image_data,(128,128))
      image_data = np.resize(image_data, (32,32))
...
train_datasets = maybe_pickle(train_folders, 401) #K is lacking  ##max is 2058
test_datasets = maybe_pickle(test_folders, 101) #K is lacking       ##max is 415
"""
...
imagePath='C:\\Users\\dabes\Desktop\\TensorFlow\\TensorFlow#5TestImage.png'
